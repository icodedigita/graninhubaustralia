...
import { ArrowLeft, ArrowUpRight, Leaf, Sparkles, Utensils, MapPin, CheckCircle2 } from "lucide-react";
  ...
  return (
    <main className="min-h-screen pt-20 md:pt-24 pb-20">
      ...
      <div className="mx-auto max-w-7xl px-5 md:px-8 mb-6">
        <Link
          href="/#products"
          className="inline-flex items-center gap-2 text-sm text-stone-600 hover:text-leaf-700 transition-colors"
        >
      ...
      <section className="mx-auto max-w-7xl px-5 md:px-8">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="relative">
            ...
            <div className={`relative aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl bg-gradient-to-br ${product.accent}`}>
              <Image
                src={product.image}
                alt={product.name}
                fill
          ...
          <div>
            ...
            <div className="mt-8 p-5 rounded-2xl bg-gradient-to-br from-leaf-50 to-brand-50 border border-leaf-200">
              ...
              <div className="mt-3 text-xs text-stone-500">
                Bulk & bagged packaging available · Worldwide shipping · Response within 1 business day
              </div>
            </div>
          </div>
        </div>
